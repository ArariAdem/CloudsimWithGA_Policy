...
public class GAInd {
	...
	Random rnd;
	VmAllocationPolicyMigrationGA GA;
	// int[] genotype;
	...
	public GAInd(VmAllocationPolicyMigrationGA ga) throws Exception {
		initialize(ga);
	...
	public GAInd(GAInd p1, GAInd p2) throws Exception {
		 ...
		 */
		// copy everything
		SortedMap<Integer, PowerHost> tempGen = new TreeMap<Integer, PowerHost>();
		int count = 0;
	...
	private void initialize(VmAllocationPolicyMigrationGA ga) {
		this.GA = ga;
		...
		gen = new TreeMap<Integer, PowerHost>();
		...
		isPareto = false;
		rnd = VmAllocationPolicyMigrationGA.rnd;
	}
