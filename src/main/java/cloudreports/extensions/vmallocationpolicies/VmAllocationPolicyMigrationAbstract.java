...
public abstract class VmAllocationPolicyMigrationAbstract extends PowerVmAllocationPolicyAbstract {
    ...
    public PowerHost findHostForVm(Vm vm, Set<? extends Host> excludedHosts) {
        ...
        for (PowerHost host : this.<PowerHost>getHostList()) {
            ...
            if (host.isSuitableForVm(vm)) {
                ...
                try {
                    double powerAfterAllocation = host.getUtilizationOfCpu() + vm.getCurrentRequestedTotalMips();
                    if (powerAfterAllocation != -1) {
                        if (powerAfterAllocation < minPower) {
                            minPower = powerAfterAllocation;
                            allocatedHost = host;
                        }
                    }
                } catch (Exception e) {
     ...
     */
    protected void setVmSelectionPolicy(VmSelectionPolicy vmSelectionPolicy) {
     ...
     */
    protected VmSelectionPolicy getVmSelectionPolicy() {
